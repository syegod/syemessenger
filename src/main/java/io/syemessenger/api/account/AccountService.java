...
public class AccountService {
  ...
  public void createAccount(SenderContext senderContext, CreateAccountRequest request) {
    ...
    if (username == null) {
      senderContext.sendError("createAccount", 400, "Missing or invalid: username");
      return;
    }
    ...
    if (email == null) {
      senderContext.sendError("createAccount", 400, "Missing or invalid: email");
      return;
    }
    ...
    if (password == null) {
      senderContext.sendError("createAccount", 400, "Missing or invalid: password");
      return;
    }
